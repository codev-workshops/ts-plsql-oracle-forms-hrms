  ...
  return (
    <section className="reports-page">
      ...
      <Routes>
        ...
        {allowed('employee-directory') && <Route path="employee-directory" element={<ReportView report={employeeDirectoryReport(ref)} />} />}
        {allowed('org-hierarchy') && <Route path="org-hierarchy" element={<ReportView report={orgHierarchyReport()} />} />}
        {allowed('employee-compensation') && <Route path="employee-compensation" element={<ReportView report={employeeCompensationReport(ref)} />} />}
        {allowed('leave-summary') && <Route path="leave-summary" element={<ReportView report={leaveSummaryReport(ref)} />} />}
        {allowed('payroll-latest') && <Route path="payroll-latest" element={<ReportView report={payrollLatestReport(ref)} />} />}
        <Route path="pending-approvals" element={<ReportView report={pendingApprovalsReport(ref)} defaults={canSeeReports ? undefined : { mine: true }} />} />
